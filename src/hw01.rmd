...
Children <- data.frame(Alter = age, Geschlecht = gender, "Fernsehzeit in h/Woche" = tv_time, "besitzt ein Smartphone" = smartphone)

Children[Children$Age < 8, c("Age", "TV")]
mean(Children[Children$Smartphone == "Yes", "TV"])
```
